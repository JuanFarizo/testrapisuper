        ...
        <div class="vx-row">
                <div class="vx-col w-full md:w-1/3 sm:w-1/2 mb-base" v-for="item in filteredKB" :key="item.id" @click="$router.push(item.url)">
                    <vx-card class="text-center cursor-pointer">
                        <img :src="require(`@/../../Dual/assets/images/pages/${item.graphic}`)" alt="graphic" width="180" class="mx-auto mb-4">
...
.knowledge-base-jumbotron-content {
    background-image: url('@/../../Dual/assets/images/pages/knowledge-base-cover.jpg');
