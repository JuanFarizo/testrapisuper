    ...
    <div class="vx-col sm:w-1/2 md:w-1/2 lg:w-2/5 m-4">
      <vx-card>
        <div class="vx-card__title mb-6">
          <h2 class="text-center">Sitio web en mantenimiento</h2>
        </div>
        <p class="text-center mb-5">¡Estamos trabajando para darte la mejor experiencia posible!</p>
        <img src="@/../../Dual/assets/images/pages/rocket.png" alt="coming-soon" class="mx-auto mb-2" width="150">
        <p class="text-center mt-5">Volverá a estar disponible en:</p>
        <div class="count-down">
          <countdown :time="new Date(openDay).getTime() - new Date().getTime()">
