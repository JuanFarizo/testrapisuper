    ...
    <div id="demo-basic-card">
        <div class="vx-row">
            <div class="vx-col w-full sm:w-1/2 lg:w-1/3 mb-base">
                <vx-card>
                    <div slot="no-body">
                        <img :src="require(`@/../../Dual/assets/images/pages/${card_1.contentImg1}`)" alt="content-img" class="responsive card-img-top">
                    </div>
                    <h5 class="mb-2">{{ card_1.title }}</h5>
                    <p class="text-grey">{{ card_1.subtitle }}</p>
                    <p class="text-grey">{{ card_1.subtitle_2 }}</p>
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#15B0CE" gradient-color-secondary="#CE9FFC">Download</vs-button>
            ...
            <div class="vx-col w-full sm:w-1/2 lg:w-1/3 mb-base">
                <vx-card>
                    <img :src="require(`@/../../Dual/assets/images/pages/${card_2.contentImg2}`)" alt="content-img" class="responsive rounded-lg">
                    <div class="my-6">
            ...
            <div class="vx-col w-full sm:w-1/2 lg:w-1/3 mb-base">
                <vx-card>
                    <img :src="require(`@/../../Dual/assets/images/pages/${card_3.contentImg3}`)" alt="content-img" class="responsive rounded-lg">
                    <div class="my-6">
                    ...
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#15B0CE" gradient-color-secondary="#CE9FFC">{{ card_3.btn_left_text }}</vs-button>
            ...
            <div class="vx-col w-full sm:w-1/2 lg:w-1/3 mb-base">
                <vx-card class="p-2">
                    <vs-avatar class="mx-auto mb-6 block" size="80px" :src="require(`@/../../Dual/assets/images/portrait/small/${card_4.userImg}`)" />
                    <div class="text-center">
                        <h4>{{ card_4.name }}</h4>
                        <p class="text-grey">{{ card_4.profession }}</p>
                    </div>
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#15B0CE" gradient-color-secondary="#CE9FFC">{{ card_4.btn_1_text }}</vs-button>
            ...
            <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
                <vx-card class="p-2">
                    ...
                    <vs-avatar class="mx-auto my-6 block" size="80px" :src="require(`@/../../Dual/assets/images/portrait/small/${ card_5.userImg }`)" />
                    ...
                    <vs-button type="gradient" class="w-full mt-6" color="#15B0CE" gradient-color-secondary="#CE9FFC">{{ card_5.btn_text }}</vs-button>
                </vx-card>
            </div>
            ...
            <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
                <vx-card class="p-2">
                    <vs-avatar class="mx-auto mb-6 block" size="80px" :src="require(`@/../../Dual/assets/images/portrait/small/${ card_6.userImg }`)" />
                    <div class="text-center">
                        <h4>{{ card_6.name }}</h4>
                    ...
                    <div class="flex justify-between flex-wrap">
                        <vs-button class="mt-4 shadow-lg" type="gradient" color="#15B0CE" gradient-color-secondary="#CE9FFC">{{ card_6.btn_left_text }}</vs-button>
            ...
            <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
                <vx-card class="overlay-card overflow-hidden">
                    <template slot="no-body">
                        <img :src="require(`@/../../Dual/assets/images/pages/${card_7.overlay_img}`)" alt="user-profile-cover" class="responsive">
            ...
            <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
                <vx-card class="overlay-card overflow-hidden">
                    <template slot="no-body">
                        <img :src="require('@/../../Dual/assets/images/pages/card-image-5.jpg')" alt="user-profile-cover" class="responsive blur-1">
                            ...
                            <VuePerfectScrollbar ref="chatLogPS" class="scroll-area pt-6 px-6" :settings="settings">
                                <ul ref="chatLog">
                                        <li class="flex items-start" :class="{'flex-row-reverse': msg.isSent, 'mt-4': index}" v-for="(msg, index) in chatMsg" :key="index">
                                            <vs-avatar size="40px" class="m-0 flex-shrink-0" :class="msg.isSent ? 'ml-3' : 'mr-3'" :src="require(`@/../../Dual/assets/images/portrait/small/${msg.senderImg}`)"></vs-avatar>
            ...
            <div class="vx-col w-full lg:w-1/3 sm:w-1/2 mb-base">
                <vx-card :title="card_9.title" :subtitle="card_9.subtitle">
                    ...
                    <img :src="require(`@/../../Dual/assets/images/pages/${card_9.img}`)" alt="content-img" class="responsive rounded-lg">
